...
- **Challenge steward:** Phase 1 uses a single contract-owner steward to assign and reveal challenges. This prevents applicants from controlling their own test, but creates a throughput and availability bottleneck. The steward cannot choose the verdict or authority amount; GenLayer judgment and deterministic contract rules remain authoritative.
