...
GitHub workflow run [34850126835](https://github.com/Ifem1/apterra/actions/runs/34850126835) passed at code commit `128440f`: 13 frontend tests; 3 browser smoke tests; production build; GenVM lint/SDK validation (3 lint checks, 25 methods); SDK typecheck; schema extraction (25 methods, 14 views, 11 writes); and 57 direct tests. The final docs-only commit still needs a fresh manual clone and CI rerun.
